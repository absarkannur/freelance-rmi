! function(e) {
    ...
    e("#preloader").fadeOut("normall", function() {
        ...
        o <= 50 ? (e("header").removeClass("scrollHeader").addClass("fixedHeader"), s.attr("src", "./lean-assets/images/logo-inner.png"), t.attr("src", "./lean-assets/images/logo.png")) : (e("header").removeClass("fixedHeader").addClass("scrollHeader"), s.attr("src", "./lean-assets/images/logo.png"), t.attr("src", "./lean-assets/images/logo.png"))
    }), (() => {
        let a = () => {
            ...
            t.css("background", `conic-gradient( #F94735 ${s}%, #0f313a ${s}%)`), a > 100 ? t.addClass("active") : t.removeClass("active"), s < 96 ? e("#scroll-value").text(`${s}%`) : e("#scroll-value").html('<i class="fa-solid fa-angle-up"></i>')
        };
        ...
        e(".service-carousel-two").owlCarousel({
            ...
            e("h2").removeClass("animated fadeInUp"), e("p").removeClass("animated fadeInUp"), e("a").removeClass("animated fadeInUp"), e(".owl-item").not(".cloned").eq(o).find("h2").addClass("animated fadeInUp"), e(".owl-item").not(".cloned").eq(o).find("p").addClass("animated fadeInUp"), e(".owl-item").not(".cloned").eq(o).find("a").addClass("animated fadeInUp")
